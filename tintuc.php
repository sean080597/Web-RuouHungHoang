					...
					<div class="panel-heading" style="text-align:center">Nhập thông tin sản phẩm</div>
						<form class="form-inline">
							<div class="form-group" style="margin: 10px auto; display: table; width:30%;">
								...
								<input type="text" class="form-control" id="Masp" placeholder="Nhập mã sản phẩm"  name="" style="text-align: center; width: 100%;">
							</div>
							</br>
							<div class="form-group" style="margin: 10px auto; display: table; width:30%;">
								<label class="">Mã loại</label>
								<input type="text" class="form-control" id="MaLoai" placeholder="Nhập mã loại" name="" style="text-align: center; width: 100%;">
							</div>
							</br>
							<div class="form-group" style="margin: 10px auto; display: table; width:30%;">
								<label class="">Tên sản phẩm</label>
								<input type="text" class="form-control" id="Tensp" placeholder="Nhập tên sản phẩm" name="" style="text-align: center; width: 100%;">
							</div>
							</br>
							<div class="form-group" style="margin: 10px auto; display: table; width:30%;">
								<label class="">Ảnh</label>
								<input type="file" class="form-control" id="anh" placeholder="" name="" style="text-align: center; width: 100%;">
							</div>
							</br>
							<div class="form-group" style="margin: 10px auto; display: table; width:30%;">
								<label class="">Dung tích</label>
								<input type="text" class="form-control" id="dungtich" placeholder="nhập dung tích" name="" style="text-align: center; width: 100%;">
							</div>
							</br>
							<div class="form-group" style="margin: 10px auto; display: table; width:30%;">
								<label class="">Giá</label>
								<input type="number" class="form-control" id="gia" placeholder="nhập giá" name="" style="text-align: center; width: 100%;">
							</div>
							</br>
							<div class="form-group" style="margin: 10px auto; display: table; width:30%;">
								<label class="">từ khóa</label>
								<input type="text" class="form-control" id="tukhoa" placeholder="từ khóa" name="" style="text-align: center; width: 100%;">
							</div>
							</br>	
