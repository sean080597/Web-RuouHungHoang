			...
			<div class="collapse navbar-collapse" id="collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li id="dangnhap_admin">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Đăng nhập</a>
								...
								<div class="panel panel-primary">
									...
									<div class="panel-heading">
										<form onsubmit="return false" id="login">
											...
											<p><br/></p>
											<a href="#" style="color:white; list-style:none;">Quên mật khẩu</a>
											<input type="submit" class="btn btn-success" style="float:right;" value="Đăng nhập" id="dangnhap" onclick="loginAdmin()">
										</form>
									</div>
